...
setTimeout("fucksjqlxl()","2500");

function fucksjqlxl(){
    console.clear()
    console.log("%c%c网站属于%cBW_Site","line-height:28px;","line-height:28px;padding:4px;background:#222;color:#fff;font-size:16px;margin-right:15px","color:#239BF5;line-height:28px;font-size:16px;");
    console.log("%c%c站长邮箱%clibw@libw.cc","line-height:28px;","line-height:28px;padding:4px;background:#222;color:#fff;font-size:16px;margin-right:15px","color:#ff9900;line-height:28px;font-size:16px;");
